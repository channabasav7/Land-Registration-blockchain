...
describe("LandRegistry", function () {
  ...
  describe("Deployment", function () {
    it("Should deploy successfully", async function () {
      expect(landRegistry.address).to.be.properAddress;
    });
  ...
  describe("Property Registration", function () {
    ...
    it("Should emit PropertyRegistered event", async function () {
      await expect(
        ...
        .withArgs("SN-2024-001", owner.address, await time.latest());
    });
  ...
  describe("Property Transfer", function () {
    ...
    it("Should emit PropertyTransferred event", async function () {
      await expect(
        ...
        .withArgs("SN-2024-001", owner.address, addr1.address, await time.latest());
    });
